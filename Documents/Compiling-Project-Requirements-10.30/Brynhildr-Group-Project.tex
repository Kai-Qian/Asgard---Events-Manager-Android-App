...
\begin{itemize}
	...
	\item Web Services
	\item SQL Lite DB
	\item Third-Party API: Google Calendar
\end{itemize}
...
\begin{enumerate}
	\item View Profile
	\begin{enumerate}
		\item Profile page with edit option
	\end{enumerate}
	
	\item View Events
	\begin{enumerate}
		\item calendar with filter (event, location)
		\begin{enumerate}
			\item register event
			\item invite friend
			\item contact organizer
			\item add to event waitlist
		\end{enumerate}
	\end{enumerate}
	...
	\item Manage Events
	\begin{enumerate}
		\item My launched events
		\begin{enumerate}
			\item list view
			\begin{enumerate}
				\item view participants
				\item modify event information
				\item delete event
